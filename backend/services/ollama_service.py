# =========================================================
# Модуль: ollama_service.py
# Назначение: Взаимодействие с моделью Ollama (текстовая и визуальная)
# Используется в: ollama_routes
# Особенности:
# - Поддерживает как обычный, так и потоковый вывод
# - Обрабатывает визуальные модели отдельно
# - Автоматически подбирает параметры температуры по уровню (0-2)
# =========================================================
