...
class Config:
    ...
    def use_fp32_config(self):
        ...
        for config_file, config_data in self.json_config.items():
            config_copy = json.loads(json.dumps(config_data))
            train_section = config_copy.get("train")
            if isinstance(train_section, dict):
                train_section["fp16_run"] = False
            self.json_config[config_file] = config_copy
