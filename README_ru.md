...
Начиная с **v0.7.1**, проект следует модульной структуре с чёткими доменными границами.
...
### 3.0. v0.7.1 — Единый медиапайплайн и ComfyUI
...
### 3.1. v0.7 — Telegram Runtime и визуальное самовыражение
